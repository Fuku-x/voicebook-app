    ...
    <View className="flex-1 bg-white items-center justify-center px-6">
      ...
      <View className="w-full max-w-sm">
        <TouchableOpacity
          ...
          className="w-full flex-row items-center justify-center gap-3 px-6 py-4 bg-white rounded-xl shadow-lg border border-gray-200"
        >
          ...
          <Text className="text-gray-900 font-medium text-base">Googleでログイン</Text>
        </TouchableOpacity>
